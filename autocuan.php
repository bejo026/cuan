...
echo "\e[96m          JANGAN LUPA BERDOA KAWAN                \n";
echo "\e[96m                     MAIN E OJO MAYAK                 \n";
echo "\e[96m            TETEP ELING LAN WASPODO               \n";
echo "\e[96m ********\e[95m".date('[d-m-Y] [H:i:s]')."\e[96m********\n";
echo "\e[95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[93m            \e[96m DUNGO SEK SAM SAK DURUNGE CLAIM \e[93m \n";
echo "\e[96m  ==============================================\n";
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[95m Pencet Y Wae Sam Bent Ra Ribet (Y/N ?: ";	
$pilihy = trim(fgets(STDIN));
if($pilihy == "y" || $pilihy == "sampun")
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
	goto login;
login:
echo "\e[96m▬▬▬ PENCET O ENTER NEG NGISOR KI  ▬▬▬▬▬\n";
$pass =  ( '║ User Login : ' );
echo "\033[30;40m";
...
else
{
		echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";	
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
		echo "\e[96m[🚫]   \e[91m WES DUNGO SEK WAE BENT KUAT NGADEPI KENYATAAN \e[96m [🚫]\n";
        echo "\e[96m[🚫]  \e[91m     PENCET O ENTER WAE CUK.. BENT RA KESUWEN     \e[96m [🚫]\n";
		echo "\e[96m[🚫]    \e[91m              DUNGO SEK CUK BENT METU VOCER E     \e[96m [🚫]\n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
ulang:
echo "\n";
echo "\e[96m ( BIM SALABIM JADI APA.. PROK.. PROK.. PROK.. $input)        \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
// function change(){
        $nama = nama();
        ...
        echo color("green","📶▶️ WES TAK KIRIM OTP ")."\n";
        otp:
        echo color("yellow","💬▶️ LEBOKNO OTP NE  : ");
        ...
        echo color("nevy","\n▬▬▬▬▬▬▬▬▬▬▬▬* SALAM GHOIB *▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","# SABAR CUK LAGI DI CLAIM 1 ");
        echo "\n".color("yellow","# SABAR O CUK ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("nevy","# TAK CLAIMKE MENEH CUK 2");
        echo "\n".color("yellow","# SABAR YA CUK ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(15);
        }
        ...
        echo "\n".color("yellow","SABAR OJO NGERSULO AE");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        echo "\n".color("yellow","# SABAR O CUK OJO NGEYELANNN AE");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        $TOKEN  = "0000000000:7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
         ...
         echo color("nevy","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PIN GOPAY = **TAKOK SENG GAWE** 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"550055"}';
